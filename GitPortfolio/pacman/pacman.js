...
//call run() function every 300 milliseconds
setInterval(run, 300)

//function used to determine the direction of the image
function checkPageBounds(direction, imgWidth) {
    
//Reverse direction when img hits the edge
  //console.log('in checkPageBounds + pos=' + pos + 'pagewidth - imgwidth='+ (pageWidth - imgWidth));
